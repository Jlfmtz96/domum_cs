...
export default function ProjectAlia() {
    const [selectedMenu, setSelectedMenu] = useState("GAlia");
    ...
    <section className="mt-40">
        <div className="container mx-auto">
            <div className="grid lg:grid-cols-4 gap-6 px-4 lg:px-0">
                ...
                {selectedMenu === "GAlia" ? ( <GAlia /> ) : ( selectedMenu === "PlantasLagos" ? ( <PlantasLagos /> ) : ( selectedMenu === "Lagos3D" ? ( <Lagos3D /> ) : ( <Entorno /> ) ))}

                </div>
                <div id="info" className=" p-10 border relative bg-white">
                    <img src={Alia} alt="" className="h-32"/>
                    <h3 className='font-bold text-4xl'>Alia Residencial</h3>
                    <div className="mt-10">
                    ...
                    <div id="menu" className="flex space-x-10 mt-20 border-t p-4 absolute bottom-0 left-0 w-full justify-center">
                        <button onClick={() => handleMenuClick("GAlia")} className={`hover:text-[#C91E7B] focus:outline-none relative group ${selectedMenu === "GAlia" ? "text-[#C91E7B]" : ""}`}>
