...
export default function Navbar() {
  ...
  return (
    <div>
        <header className={`py-6 px-10 fixed top-0 w-full justify-between z-40 text-white transition-all duration-300 ease-in-out ${
          isScrolled ? 'bg-white opacity-90' : ''
        }`}>
            <div className="container mx-auto flex items-center">
                <div className="flex flex-grow basis-0">
                    <a href="/">
                        <img src={isScrolled ? LogoColor : Logo} alt="" className={`w-36 transition-all duration-300 ease-in-out ${isScrolled ? 'filter-invert' : ''}`}/>
